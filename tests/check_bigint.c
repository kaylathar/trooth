...
#define TWELVE_TO_ONETWENTYTHIRD "5486473221892422150934082166721730811348667928100671624512517021843456541709523359082780720277398867836972367369456704108169294512128"
...
START_TEST(bigint_exponentiate)
{
	TR_Environment *env = TR_Environment_alloc();
